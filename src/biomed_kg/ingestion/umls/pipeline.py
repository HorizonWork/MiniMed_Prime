...
from biomed_kg.ingestion.base import RawFile, RawRecord, SourceIngestionPipeline
from biomed_kg.ingestion.umls.mrconso_parser import parse_mrconso
from biomed_kg.ingestion.umls.mrdef_parser import parse_mrdef
from biomed_kg.ingestion.umls.mrhier_parser import parse_mrhier
from biomed_kg.ingestion.umls.mrrel_parser import parse_mrrel
from biomed_kg.ingestion.umls.mrsty_parser import parse_mrsty
from biomed_kg.ingestion.umls.normalizer import (
...
class UMLSIngestionPipeline(SourceIngestionPipeline):
    ...
    def download(self) -> list[RawFile]:
        return [RawFile(name) for name in ["MRCONSO.RRF", "MRSTY.RRF", "MRREL.RRF", "MRHIER.RRF", "MRDEF.RRF", "MRMAP.RRF"]]
