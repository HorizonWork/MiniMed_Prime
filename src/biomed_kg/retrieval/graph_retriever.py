...
class GraphRetriever:
    ...
    def retrieve_treatment_direct(self, plan, template):
        ...
        return self.neo4j.query(
            ...
            LIMIT $limit
            """,
            {"disease_id": disease.entity_id, "min_confidence": template.min_edge_confidence, "limit": 50},
        )
    ...
    def retrieve_adverse_effect_direct(self, plan, template):
        ...
        return self.neo4j.query(
            ...
            LIMIT $limit
            """,
            {"ae_id": adverse_event.entity_id, "min_confidence": template.min_edge_confidence, "limit": 50},
        )
