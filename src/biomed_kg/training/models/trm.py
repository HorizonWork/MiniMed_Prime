...
class TinyRecursiveReasoner(nn.Module):
    def __init__(self, num_entities, num_relations, num_task_types, num_metapaths, hidden_dim, recursion_steps):
        super().__init__()
        ...
        self.recursive_cell = nn.Sequential(nn.Linear(hidden_dim, hidden_dim), nn.GELU(), nn.Linear(hidden_dim, hidden_dim))
