...
def make_assertion_id(
    subject_id: str, predicate: str, object_id: str, source_system: str, source_record_id: str
) -> str:
    return (
        f"ASSERT:{stable_hash(subject_id, predicate, object_id, source_system, source_record_id)}"
    )
