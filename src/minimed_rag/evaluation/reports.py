...
class EvaluationSuite:
    def __init__(
        self,
        kg_quality_evaluator,
        entity_linking_evaluator,
        retrieval_evaluator,
        reasoning_evaluator,
        trm_evaluator,
        report_writer,
    ...
    def run_all(self, graph_version: str) -> EvaluationReport:
        report = EvaluationReport(
            graph_version,
            self.kg_quality_evaluator.evaluate(graph_version),
            self.entity_linking_evaluator.evaluate(graph_version),
            self.retrieval_evaluator.evaluate(graph_version),
            self.reasoning_evaluator.evaluate(graph_version),
            self.trm_evaluator.evaluate_latest(graph_version),
        )
