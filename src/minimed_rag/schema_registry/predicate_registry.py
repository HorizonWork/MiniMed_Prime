...
class PredicateRegistry:
    ...
    def sample_incompatible_predicate(
        self, subject_type: str, object_type: str, original_predicate: str
    ) -> str:
        for predicate in self.rules:
            if predicate != original_predicate and not self.is_valid_domain_range(
